...
int PWM_M1 = 110; //****************************************brzina motora M1
...
GO_RIGHT = analogRead(RC_RIGHT); 
      ...
      if ((GO_FW > 1000) && (GO_RW < 100))//napred
            ...
            while ((GO_FW > 1000) && (GO_RW < 100))//napred
              ...
              if(fw==0)
              {
                for(;PWM_DUTY_FW<PWM_M1;PWM_DUTY_FW++) 
                 {
              ...
              analogWrite(M1_Q1,PWM_DUTY_FW);          // PWM M1
              }
             ...
             if (millis() - AUTO_FW_TIME_CHECK > 2000)
                {
                  while (!(GO_RW > 1000) && !(GO_FW < 50))//dokle god se nestisne RW idi samo napred
                      {
                       ...
                       if ((GO_LEFT > 1000) && (GO_RIGHT < 100)) 
                            {delay(20);
                             while ((GO_LEFT > 1000) && (GO_RIGHT < 50)) 
                             {
                      ...
                      //END **************************  LEFT  *******************
                      digitalWrite(M1_Q2,HIGH);//levi ponovo upali 
                      
                         //**************************  RIGHT  **********************
                         if ((GO_RIGHT > 1000) && (GO_LEFT < 50)) 
                            //if ((GO_RIGHT > 1000)) 
                             {delay(20);
                                while ((GO_RIGHT > 1000) && (GO_LEFT < 50)) 
                                  { 
                         ...
                         //END **************************  RIGHT  *******************
                       digitalWrite(M2_Q2,HIGH);//desni ponovo upali
      ...
      if (fw==1) //************************************************slow down from FW
        ...
        if  ((GO_RW > 1000) && (GO_FW < 100)) //nazad
              ...
              if(rw==0)
              {
                for(;PWM_DUTY_RW <PWM_M1;PWM_DUTY_RW++)
                 {
               ...
               rw=1;
                 ...
                 //analogWrite(M2_Q4,PWM_DUTY_RW+PWM_DIFF); //M2-255; M1-185
...
//    digitalWrite(M1_Q1,HIGH); //M1
              ...
              analogWrite(M2_Q1,100);  //M2 FW  
              analogWrite(M1_Q4,80); //M1 RW
