...
// the pins that the Motor1 is attached to (LEFT controller)
const int M1_Q1= 10;
const int M1_Q2 = 13;
const int M1_Q3= 12;
const int M1_Q4= 11;

// the pins that the Motor1 is attached to (RIGHT controller)
const int M2_Q1= 9;
const int M2_Q2= 6;
const int M2_Q3 = 7;
const int M2_Q4= 8;
...
GO_RIGHT = analogRead(RC_RIGHT); 
      ...
      if ((GO_FW > 900) & (GO_RW < 100))//napred
            {
            delay(20);
            while ((GO_FW > 900) & (GO_RW < 100))//napred
              {
